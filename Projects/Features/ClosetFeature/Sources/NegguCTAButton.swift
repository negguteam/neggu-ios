                        ...
                        VStack(alignment: .leading, spacing: 20) {
                            Button {
                                ...
                                VStack(alignment: .leading, spacing: 12) {
                                    HStack(spacing: 12) {
                                        GradientView {
                                            NegguImage.Icon.smallNegguStar
                                        }
                            ...
                            GnbOpendedViewItem(
                                "초대코드로 꾸며주기",
                                leftIcon: NegguImage.Icon.number,
                    ...
                    case .generateInvite:
                        VStack(spacing: 20) {
                            ...
                            RoundedRectangle(cornerRadius: 8)
                                .fill(NegguDSAsset.Colors.gray70.swiftUIColor)
                                .frame(height: 36)
                                .overlay {
                                    HStack(spacing: 12) {
                                        Text("내 초대코드")
...
//                            }))
                    ...
                    case .acceptInvite:
                        VStack(alignment: .leading, spacing: 20) {
                            GnbOpendedViewItem("초대코드로 꾸며주기", leftIcon: NegguImage.Icon.number)
                                .negguFont(.body1b)
